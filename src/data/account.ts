...
export const ADMIN_CHAT_SEED: ChatMessage[] = [
  {
    id: 'adm-1',
    author: 'admin',
    text: 'Здравствуйте, Юсиф! Напоминаем о консультации с Лейлой Мамедовой. Ссылка на видеовстречу придёт за 15 минут до начала.',
  ...
  },
  {
    id: 'adm-3',
    author: 'admin',
    text: 'Конечно, у Лейлы свободно 18:00 в тот же день. Перенесла вашу запись, подтверждение уже в разделе «Кабинет».',
